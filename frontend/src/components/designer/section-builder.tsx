...
export default function SectionBuilder({ panels, setPanels, selectedTheme }: SectionBuilderProps) {
  ...
  return (
    <div className="w-1/2 bg-gray-50">
      <div className="p-6 border-b border-gray-200 bg-white">
        <h3 className="text-lg font-semibold text-charcoal mb-2">Section Builder</h3>
